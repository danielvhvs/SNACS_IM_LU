...
def plot_spread(path, data_name, algs):
    ...
    ax.set_title(
        "influence spread for different seed sizes and algorithms", fontsize=fsize
    )
...
def plot_time(path, data_name, algs):
    ...
    ax.set_title(
        "run time for different algorithms for different seed sizes", fontsize=fsize
    )
    ax.tick_params(axis="both", labelsize=fsize)
    plt.show()
...
def plot_time_bar(path, data_name, algs):
    ...
    ax.set_ylabel("run time (s)", fontsize=fsize)
    ax.set_title(
        "run time for different algorithms for different seed sizes as a barplot",
        fontsize=fsize,
    )
    ax.tick_params(axis="both", labelsize=fsize)
    ax.set_yscale("log")
